...
> 
> **Explanation:** 
> 1. Convert 75 to binary: .
> 2. Since it is positive, the 8-bit two's complement is the same as the standard binary.
...
> 
> **Explanation:** 
> 1. Start with +43 in binary: `00101011`.
> 2. Invert all bits (One's complement): `11010100`.
> 3. Add 1: `11010100 + 1 = 11010101`.
...
> 
> **Explanation:** An overflow error in two’s complement addition only occurs when adding two numbers with the **same sign** (positive + positive or negative + negative) results in a sum with the opposite sign. Since one number is positive (75) and the other is negative (-43), the result will always fall within the representable range of -128 to +127.
...
> **Answer:** TIFF is a **lossless** format (or uncompressed), meaning it preserves all original image data and quality, whereas JPG uses **lossy** compression which discards data to reduce file size.
